...
public class MojRasporedAdapter extends BaseAdapter {
	Context context;
	ArrayList<PredmetMojRaspored> popis;
	MojRasporedBaza baza;
	int prijePoslije;
	public MojRasporedAdapter(Context c, MojRasporedBaza baza, int prijePoslije){
		context=c;
		this.baza=baza;
		this.prijePoslije=prijePoslije;
	}
	public void setPopis(ArrayList<PredmetMojRaspored> popis){
		this.popis=popis;
	...
	public MojRasporedAdapter getAdapter(){
		return MojRasporedAdapter.this;
	}
